...
target_rec = []
survey_rec = []
for scatter in pyl.arange(0.1, 0.75, 0.05):
...
inset.plot(pyl.arange(0.1, 0.75, 0.05), target_rec, '-', c='#7a68a6')
inset.plot(pyl.arange(0.1, 0.75, 0.05), survey_rec, '--', c='#188487')
inset.set_xlabel('$\sigma_{true}$', fontsize=12)
inset.set_ylabel('$\sigma_{rec}$', fontsize=12)
inset.set_xlim(0, 0.75)
inset.set_ylim(0, 0.75)

inset.set_xticks([0.2, 0.4, 0.6])
inset.set_yticks([0.2, 0.4, 0.6])
