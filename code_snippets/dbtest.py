...
db = DBSCAN(eps=0.89, min_samples=10).fit(data)
labels = db.labels_
...
ax1.scatter(c1[:,0], c1[:,1], lw=0.5, color='#348abd')
ax1.scatter(c2[:,0], c2[:,1], lw=0.5, color='#467821')
ax1.scatter(c3[:,0], c3[:,1], lw=0.5, color='#e24a33')
...
ax2.scatter(dbc1[:,0], dbc1[:,1], lw=0.5, color='#348abd')
ax2.scatter(dbc2[:,0], dbc2[:,1], lw=0.5, color='#467821')
ax2.scatter(noise[:,0], noise[:,1], lw=0.5, color='#e24a33')
